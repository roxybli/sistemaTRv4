...
--
-- Host: localhost
-- Generation Time: Sep 28, 2018 at 07:27 AM
...
(65, 'mesa', 1, 1, 1, 17),
(66, 'silla', 1, 1, 1, 17),
(67, 'pan frances', 0, 0.52, 2, 18),
(68, 'Horno', 1, 1000, 1, 18);
...
(1, '$contenido', '$contacto', '$emisor', 2, 'Nuevo'),
(2, '$contenido', '$contacto', '$emisor', 1, NULL),
(4, '', 'hshshs', 'shsh', 1, NULL),
(5, 'p', 'pp', 'hpapa', 1, NULL),
(6, 'hh', 'hhh', 'hhh', 1, NULL),
(7, 'lalal', 'alala', 'hola', 1, NULL),
(8, 'lalal', 'alala', 'hola', 1, NULL),
(9, 'lalal', 'alala', 'hola', 1, NULL),
(10, 'jsjsjs', 'jsjsj', 'jsjs', 1, NULL),
(11, 'hahah', 'hahah', 'hahsh', 1, NULL),
(12, '', '', '', 1, NULL),
(13, 'Hola como tu te llama', '72491546', 'Javier', 1, 'Leido'),
(14, 'hola ', '4558', 'lili', 1, 'Leido'),
(15, 'hshshshs', 'hshsh', 'hshsh', 1, 'Leido'),
(16, 'hshshs', 'hshsh', 'hshsh', 1, 'Leido'),
(17, 'Hola                                    \n                                ', '1111', 'Javier', 6, 'Nuevo');
...
(1, 1, 'asad', 'aDAD', '', 1, 'Roxana Blanco1/f3.jpg', 'Roxana Blanco1/f1.jpg', 'Roxana Blanco1/f2.jpg', 'Roxana Blanco1/f4.jpg', '7777', '7777', 17),
...
(1, 1, 'Roxana', 'Blanco', 'roxwite', '123456', 'San Miguel', 1, '72787475', '1111455-0', '2027-09-18'),
...
(6, 1, 'maria', 'ramirez', 'maria', '123', 'san miguel', 3, '1235', '111111', '2027-09-18');
...
--
ALTER TABLE `tbl_Elementos_Subrubros`
MODIFY `Pk_Id_Elemento_Subrubro` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=69;
--
...
--
ALTER TABLE `tbl_Mensajes`
MODIFY `PK_Id_Mensaje` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT for table `tbl_Perfiles_Empresariales`
--
ALTER TABLE `tbl_Perfiles_Empresariales`
MODIFY `pk_Id_Perfil` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `tbl_Rubros`
MODIFY `PK_Id_Rubro` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `tbl_Usuarias`
MODIFY `pk_Id_Usuaria` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
