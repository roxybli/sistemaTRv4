                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-two">
                                    <header>
                                        <div class="avatar">
                                            <img src="<?=base_url() ?>plantilla/images/rox.jpg" alt="Allison Walker" />
                                        </div>
                                    </header>

                                    <h3>Roxana Blanco</h3>
                                    <div class="desc">
                                        Ingeniera en Sistemas Informaticos, apasionada por la tecnologia.
                                    </div>
                                    <div class="contacts">
                                ...
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="card-body">
                                        <div class="profiletimeline">
                                            <div class="sl-item">
                                                <div class="sl-left"> <img src="<?=base_url() ?>plantilla/images/users/avatar-1.jpg" alt="user" class="img-circle" /> </div>
                                                <div class="sl-right">
                                                    <div><a href="#" class="link">Michael Qin</a> <span class="sl-date">5 minutes ago</span>
                                                        <p>assign a new task <a href="#"> Design weblayout</a></p>
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="<?=base_url() ?>plantilla/images/big/img1.jpg" class="img-responsive radius" /></div>
                                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="<?=base_url() ?>plantilla/images/big/img2.jpg" class="img-responsive radius" /></div>
                                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="<?=base_url() ?>plantilla/images/big/img3.jpg" class="img-responsive radius" /></div>
                                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="<?=base_url() ?>plantilla/images/big/img4.jpg" class="img-responsive radius" /></div>
                                                        </div>
                                            ...
                                            <hr>
                                            <div class="sl-item">
                                                <div class="sl-left"> <img src="<?=base_url() ?>plantilla/images/users/avatar-2.jpg" alt="user" class="img-circle" /> </div>
                                                <div class="sl-right">
                                                    <div> <a href="#" class="link">Michael Qin</a> <span class="sl-date">5 minutes ago</span>
                                                        <div class="m-t-20 row">
                                                            <div class="col-md-3 col-xs-12"><img src="<?=base_url() ?>plantilla/images/big/img1.jpg" alt="user" class="img-responsive radius" /></div>
                                            ...
                                            <hr>
                                            <div class="sl-item">
                                                <div class="sl-left"> <img src="<?=base_url() ?>plantilla/images/users/avatar-3.jpg" alt="user" class="img-circle" /> </div>
                                                <div class="sl-right">
                                                    <div><a href="#" class="link">Michael Qin</a> <span class="sl-date">5 minutes ago</span>
                                            ...
                                            <hr>
                                            <div class="sl-item">
                                                <div class="sl-left"> <img src="<?=base_url() ?>plantilla/images/users/avatar-4.jpg" alt="user" class="img-circle" /> </div>
                                                <div class="sl-right">
                                                    <div><a href="#" class="link">Michael Qin</a> <span class="sl-date">5 minutes ago</span>
